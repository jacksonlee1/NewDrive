...
public class RobotMap {
  ...
  public static final Motor L_MOTOR = drivetrain::setLeftMotor;
  public static final Motor R_MOTOR = drivetrain::setRightMotor;
  public static final DirectionSource GYRO = () -> {
    return Math.toRadians(drivetrain.getHeading());
};
public static final DistanceSource L_DISTANCE_SOURCE = drivetrain::getLeftDistance;
public static final DistanceSource R_DISTANCE_SOURCE = drivetrain::getRightDistance;
